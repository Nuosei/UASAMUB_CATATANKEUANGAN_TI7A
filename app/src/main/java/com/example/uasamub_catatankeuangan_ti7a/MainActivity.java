...
import com.example.uasamub_catatankeuangan_ti7a.ModelKeuangan;
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            fireAuthListener = new FirebaseAuth.AuthStateListener() {
                ...
                public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                    ...
                    if (users == null) {
                        com.example.uasamub_catatankeuangan_ti7a.startActivity(new Intent(com.example.uasamub_catatankeuangan_ti7a.this, LoginActivity.class));
                        com.example.uasamub_catatankeuangan_ti7a.this.finish();
                    }
                }
            };
                                    ...
                                    public void onComplete(@NonNull Task<Void> task) {
                                        if (task.isSuccessful()) {
                                            userpass.updatePassword(newPassText).addOnCompleteListener(new OnCompleteListener<Void>() {
                                                ...
                                                public void onComplete(@NonNull Task<Void> task) {
                                                    if (task.isSuccessful()) {
                                                        Toast.makeText(com.example.uasamub_catatankeuangan_ti7a.ProfileActivity.this, "Password is updated, sign in with new password!", Toast.LENGTH_SHORT).show();
                                                        firebaseAuth.signOut();
                                                        Intent intent = new Intent(com.example.uasamub_catatankeuangan_ti7a.ProfileActivity.this, LoginActivity.class);
                                                        intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                                                        startActivity(intent);
